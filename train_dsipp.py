...
from t5_pretrainer.mixlora import MixLoraDSI_sequential_finetuning
from t5_pretrainer.mixlora_config import MixLoraConfig
from t5_pretrainer.mixlora_trainer import SAM_Trainer
...
model_dict = {
    ...
    "mixloradsi": MixLoraDSI_sequential_finetuning,
}
