...
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/data/miniconda3/envs/mixlora_dsi/lib
...
split=d0
data_root_dir=./mixlora_dsi/msmarco/$split
experiment_dir=experiments
codebook_num=8
codebook_bits=11

collection_path=$data_root_dir/full_collection/
model_dir=$data_root_dir/$experiment_dir/msmarco_t5-self-neg-marginmse-5e-4
...
python3 change_customized_embed_layer.py \
    ...
    --codebook_num=$codebook_num \
    --codebook_bits=$codebook_bits \
    --out_dir=./mixlora_dsi/msmarco/d0/experiments/rq_smtid \
    --mmap_dir=$mmap_dir \
