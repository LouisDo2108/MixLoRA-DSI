...
# Previous split
data_root_dir=./mixlora_dsi/msmarco/$previous_split
collection_path=$data_root_dir/full_collection/

flat_index_dir=./mixlora_dsi/msmarco/$previous_split/experiments/mmap
rq_index_dir=./mixlora_dsi/msmarco/$previous_split/experiments/mmap_rq

# Current split
new_data_root_dir=./mixlora_dsi/msmarco/$current_split
...
torchrun --master_port=26000 --nproc_per_node=1 add_rq.py \
    --codebook_num=8 \
    --codebook_bits=11 \
    --index_retrieve_batch_size=1024 \
    --collection_path=$collection_path \
    --pretrained_path=./mixlora_dsi/msmarco/d0/experiments/t5-self-neg-marginmse-5e-4/checkpoint \
