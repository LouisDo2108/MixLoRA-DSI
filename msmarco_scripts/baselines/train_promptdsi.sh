...
initial_config="./MixLoraDSI/config/baselines/promptdsi.json"
epoch=10
num_tasks=4
batch_size=512 # We use batch size of 32 for NQ320k MixLoRA-DSI with pre-trained
