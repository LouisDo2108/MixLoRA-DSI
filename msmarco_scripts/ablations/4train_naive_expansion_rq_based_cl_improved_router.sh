...
run_name="row4_naive_expansion_rq_based_cl_improved_router"
base_dir="./mixloradsi/msmarco"
initial_config="./MixLoraDSI/config/msmarco/ablations/row4_naive_expansion_rq_based_cl_improved_router.json"
epoch=5
num_tasks=4
...
for ((i = 1; i <= num_tasks; i++)); do
    ...
    if [ $i -eq 1 ]; then
        model_dir="$base_dir/d0/$experiment_dir/mixloradsi-pt"
