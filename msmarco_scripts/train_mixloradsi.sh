...
initial_checkpoint_name="mixloradsi" # mixloradsi mixloradsi-pt
experiment_dir="experiments"
run_name="mixloradsi-ood_-1%"
base_dir="./mixloradsi/msmarco"
initial_config="./MixLoraDSI/config/msmarco/mixloradsi-ood_-1%.json"
epoch=5
num_tasks=4
