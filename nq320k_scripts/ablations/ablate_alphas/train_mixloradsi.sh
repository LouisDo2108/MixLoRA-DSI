...
run_name=mixloradsi-pt_10%
initial_mixlora_config_path=./MixLoraDSI/config/nq320k/mixloradsi-pt_10%.json
num_tasks=4
...
do
  ...
  data_root_dir=/home/thuy0050/ft49_scratch2/thuy0050/mixloradsi/nq320k/$current_split
  ...
  if [ $i -eq 1 ]; then
    model_dir=/home/thuy0050/ft49_scratch2/thuy0050/mixloradsi/nq320k/d0/$experiment_dir/mixloradsi-pt
    mixlora_config_json_path=$initial_mixlora_config_path
    epoch=10
  else
    model_dir=/home/thuy0050/ft49_scratch2/thuy0050/mixloradsi/nq320k/$previous_split/$experiment_dir/$run_name
    mixlora_config_json_path=/home/thuy0050/ft49_scratch2/thuy0050/mixloradsi/nq320k/$previous_split/$experiment_dir/$run_name/mixlora_config.json
    epoch=10
  fi
  ...
  do
        ...
        data_root_dir=/home/thuy0050/ft49_scratch2/thuy0050/mixloradsi/nq320k/$train_split
        model_dir=$data_root_dir/$experiment_dir/$run_name
        out_dir=$data_root_dir/$experiment_dir/$run_name/out
        docid_to_tokenids_path=/home/thuy0050/ft49_scratch2/thuy0050/mixloradsi/nq320k/$train_split/experiments/rq_smtid/docid_to_tokenids.json
        
        eval_split=d$eval_i
        q_collection_paths=/home/thuy0050/ft49_scratch2/thuy0050/mixloradsi/nq320k/$eval_split/eval_queries
        eval_qrel_path=$q_collection_paths/eval_qrel.json
        mixlora_config_json_path=/home/thuy0050/ft49_scratch2/thuy0050/mixloradsi/nq320k/$train_split/$experiment_dir/$run_name/mixlora_config.json

        torchrun --master_port=25750 --nproc_per_node=1 eval_mixlora.py \
                --pretrained_path=$model_dir \
                --mixlora_config_json_path=$mixlora_config_json_path \
