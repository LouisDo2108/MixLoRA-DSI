...
declare -a initial_configs=(
    "./MixLoraDSI/config/ablations/alphas/mixloradsi/0.1-0.1.json"
    "./MixLoraDSI/config/ablations/alphas/mixloradsi/0.1-0.5.json"
    "./MixLoraDSI/config/ablations/alphas/mixloradsi/0.1-0.05.json"
)
...
do
    ...
    do
        ...
        do
            ...
            torchrun --master_port=25450 --nproc_per_node=1 eval_mixlora.py \
            --pretrained_path=$model_dir \
            --mixlora_config_json_path=$mixlora_config_json_path \
