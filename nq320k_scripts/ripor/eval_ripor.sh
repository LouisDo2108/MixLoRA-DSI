...
train_split=d0
data_root_dir=./mixloradsi/nq320k/$train_split
experiment_dir=experiments
run_name=mixloradsi-pt

model_dir=$data_root_dir/$experiment_dir/$run_name
docid_to_tokenids_path=./mixloradsi/nq320k/$train_split/experiments/rq_smtid/docid_to_tokenids.json
...
do
        eval_split=d$i
        q_collection_paths=./mixloradsi/nq320k/$eval_split/eval_queries
