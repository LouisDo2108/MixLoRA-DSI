...
from t5_pretrainer.mixlora import MixLoraDSI_sequential_finetuning as MixLoraDSI
from t5_pretrainer.mixlora_config import MixLoraConfig
from t5_pretrainer.mixlora_trainer import MixLoraDSI_SequentialFinetuning_Trainer
...
def main():
    ...
    # Adding KL loss as a baseline
    # model.previous_checkpoint = copy.deepcopy(model.base_model).cuda()
    model._before_task()

    trainer = MixLoraDSI_SequentialFinetuning_Trainer(
        model=model,
        args=training_args,
